...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            @else
            {{ Form::open(['route'=>['admin.companies.create'],'method' => 'put','class'=>'form-horizontal form-label-left']) }}
            @endif
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="id" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('id')) parsley-error @endif"
                               name="id" value="{{setFormValue('id', $company)}}" disabled="disabled" required>
                        @if($errors->has('id'))
            ...
            @endif
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('name')) parsley-error @endif"
                               name="name" value="{{setFormValue('name', $company)}}" maxlength='50' required>
                        @if ($errors->has('name'))
                            <ul class="parsley-errors-list filled">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name_kana" type="name_kana" class="form-control col-md-7 col-xs-12 @if($errors->has('name_kana')) parsley-error @endif"
                               name="name_kana" value="{{setFormValue('name_kana', $company)}}" maxlength='100' required>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      <input id="ontract_status" type="contract_status" class="form-control col-md-7 col-xs-12 @if($errors->has('contract_status')) parsley-error @endif"
                             name="contract_status" value="{{setFormValue('contract_status', $company)}}" maxlength='100' required>
                      @if ($errors->has('contract_status'))
                          <ul class="parsley-errors-list filled">
                              @foreach ($errors->get('contract_status') as $error)
                                  <li class="parsley-required">{{ $error }}</li>
                              @endforeach
                          </ul>
                      @endif
