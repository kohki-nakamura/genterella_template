...
var inArray = function inArray(val, array) {
  return $.inArray(val, array) !== -1;
};

var arrayDiff = function arrayDiff(array1) {
...
var arrayDuplicate = function arrayDuplicate(array1) {
  var array2 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
...
var arrayUnique = function arrayUnique(array) {
  var res = array.filter(function (x, i, self) {
    return self.indexOf(x) === i && i !== self.lastIndexOf(x);
  });
  return res;
};

var arrayEmpty = function arrayEmpty(array) {
